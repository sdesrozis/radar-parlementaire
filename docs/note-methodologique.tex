...
écarte les scrutins antérieurs — ou postérieurs — au mandat : on ne reproche pas
à un élu arrivé en cours de législature les votes tenus avant son arrivée. Le
second ($R_i$) écarte les non-votes que l'institution impose. Le plancher à zéro
...
\textbf{Deux mesures sur trois sont publiées sans intervalle.} La position
latente est accompagnée de son intervalle de bootstrap
(section~\ref{sec:bootstrap}), et le site refuse d'ordonner deux députés dont
les intervalles se recouvrent. La participation et la dissidence, elles, sont
des proportions binomiales : elles ont un intervalle calculable, et il n'est
aujourd'hui ni calculé ni affiché. Un intervalle de Jeffreys à 90~\% sur le taux
de dissidence fait environ un point de large pour un député médian, et jusqu'à
quatre points pour ceux dont le taux est élevé — de sorte qu'un rang publié
sans réserve recouvre en réalité plusieurs dizaines de positions
indiscernables. C'est une asymétrie de rigueur entre indicateurs, et elle n'a
pas de justification méthodologique : le site refuse d'ordonner deux positions
latentes qui se recouvrent, et ordonne sans réserve deux taux de dissidence qui
se recouvrent tout autant.
